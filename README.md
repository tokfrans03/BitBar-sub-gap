...
A [BitBar](https://github.com/matryer/bitbar) plugin that Displays the sub gap between any two youtube channels, such as Pewdiepie and T-series. Put your youtube api key in the script. You can also change the channel ids to check on other sub gaps, just make shure the bigger one is first.
